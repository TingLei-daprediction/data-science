                                ...
                                html.Div([
                                    ...
                                    html.Div([
                                        ...
                                        dcc.Dropdown(id='input-type', 
                                                     ...
                                                     options=[{'label':'OPT1' , 'value': 'OPT1'},{'label':'OPT2' , 'value': 'OPT2'}],
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
        ...
        if chart == 'OPT1':
            ...
            # Enter your code below. Make sure you have correct formatting.
            line_fig = px.line(line_data, x='Reporting Airline', y='AirTime', color='CancellationCode', title='Monthly Flight Airtime')
            ...
            tree_fig=px.tree(tree_data,path=['DestState', 'Reporting_Airline'],
                 values='Flights')
